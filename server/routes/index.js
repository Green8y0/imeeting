...
router.post('/createreservations', controllers.createreservations)
router.get('/getreservations', controllers.getreservations)
router.post('/creategroups', controllers.creategroups)
router.get('/getgroups', controllers.getgroups)
...
router.post('/setleader', controllers.setleader)
router.post('/deletereservations', controllers.deletereservations)
